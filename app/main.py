...
from app.core.middleware import DatabasePoolGuardMiddleware, RequestTimeoutMiddleware
...
def create_app() -> FastAPI:
    ...
    app.add_middleware(
        DatabasePoolGuardMiddleware, threshold=settings.database_pool_reject_threshold
    )
